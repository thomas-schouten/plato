            ...
            if _age in points.data.keys():
                ...
                for key, entries in _iterable.items():
                    ...
                    for _plateID in _plateIDs:
                        ...
                        self.data[_age][key].loc[self.data[_age][key].plateID == _plateID, "velocity_mean_azi"] = rms_velocity[1]
                    ...
                    if len(entries) > 1:
                        self.data[_age] = utils_data.copy_values(
                            ...
                            key, 
                            entries, 
                            ["velocity_rms_mag", "velocity_mean_azi", "spin_rate_rms_mag"], 
                        )
    ...
    def calculate_driving_torque(
        ...
        for i, _age in enumerate(_tqdm(
            ...
            for _case in _cases:
                ...
                computed_data = utils_calc.sum_torque(_data[mask], "driving")
    ...
    def calculate_residual_torque(
        ...
        for _case in _tqdm(
            ...
            for _age in _ages:
                ...
                # Calculate driving torque
                computed_data = utils_calc.sum_torque(_data[mask], "residual")
